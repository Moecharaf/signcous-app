      ...
      <div className="w-full px-3 py-3 md:px-4">
          ...
          <div className="grid items-end gap-4 lg:grid-cols-1">
            <div>
              <nav aria-label="Breadcrumb" className="flex flex-wrap items-center gap-2 text-xs text-zinc-500">
                ...
                <span>/</span>
                <span className="font-semibold text-zinc-900">GF830 AutoMark (Wrap Vinyl)</span>
              </nav>
              <div className="mt-2 flex flex-wrap gap-2">
                {[
                  "GF830 AutoMark",
                  "60in Panel Split Logic",
                  "Tiered Rate Pricing",
                  "Gloss / Matte / None",
                ].map((item) => (
              ...
              <h1 className="mt-3 text-3xl font-semibold tracking-tight text-zinc-900">GF830 AutoMark (Wrap Vinyl) Builder</h1>
        ...
        <div className="grid gap-4">
          ...
          <aside className="space-y-3">
            <PanelCard eyebrow="Pricing" title="GF830 AutoMark Breakdown">
              <div className="space-y-1">
                ...
                <BreakdownRow label="Minimum floor" value={formatCurrency(GF830_MINIMUM_PRICE)} muted={!pricing} />
                <BreakdownRow
            ...
            <PanelCard eyebrow="Usage" title="Laminate Notes">
              <div className="space-y-2 text-sm text-zinc-600">
                {GF830_LAMINATE_OPTIONS.map((option) => (
