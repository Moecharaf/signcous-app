    ...
    <div className="flex h-[calc(100vh-88px)] overflow-hidden">
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white shadow-sm">
            ...
            <div className="grid gap-2 border-t border-zinc-200 bg-zinc-50 p-3 md:grid-cols-6 xl:grid-cols-12">
              ...
              <ControlBox title="Units" className="md:col-span-2 xl:col-span-2" helper="Switch between inches and feet.">
                <select
                  value={unit}
                  onChange={(event) => setUnit(event.target.value as GF830Unit)}
              ...
              <ControlBox title="Laminate" className="md:col-span-2 xl:col-span-3" helper={selectedLaminate.note}>
                <select
                  value={laminate}
                  onChange={(event) => setLaminate(event.target.value as GF830Laminate)}
                  className="h-9 w-full rounded border border-zinc-300 bg-white px-2 text-sm"
                >
              ...
              <ControlBox title="Split Direction" className="md:col-span-3 xl:col-span-4" helper="Auto follows 60in panel logic.">
                <select
                  value={splitDirection}
                  onChange={(event) => setSplitDirection(event.target.value as GF830SplitDirection)}
                  className="h-9 w-full rounded border border-zinc-300 bg-white px-2 text-sm"
                >
              ...
              <ControlBox title="Contour / Rush" className="md:col-span-2 xl:col-span-3" helper="Contour +10%, Rush +100%.">
      ...
      <div className="flex w-[400px] flex-shrink-0 flex-col border-l border-zinc-200 bg-white">
        <div className="border-b border-zinc-100 px-5 py-4">
          ...
          <div className="mt-1 text-lg font-bold tracking-tight text-zinc-900">G F830</div>
        </div>
