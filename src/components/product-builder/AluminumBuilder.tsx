          ...
          {pricingMode === "sheet" && sheetLayout && (
            <section className="rounded-2xl border border-zinc-200 bg-white shadow-sm">
              ...
              >
                ...
                <div className="pointer-events-none absolute left-[calc(50%-124px)] top-1/2 -translate-y-1/2 -rotate-90 text-[10px] font-semibold uppercase tracking-[0.2em] text-zinc-500">Left</div>
                <div className="pointer-events-none absolute left-[calc(50%+92px)] top-1/2 -translate-y-1/2 rotate-90 text-[10px] font-semibold uppercase tracking-[0.2em] text-zinc-500">Right</div>
              </div>
