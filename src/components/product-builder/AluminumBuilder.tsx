            ...
            <div className="space-y-2">
              <div className="grid grid-cols-[1fr_1fr_auto] gap-1">
                <input
                  ...
                  min={0}
                  step={1}
                  value={customWidthParts.feet}
                  onChange={e => setCustomWidth(Math.max(0.5, composeDimensionInches(e.target.value, customWidthParts.inches)))}
                ...
                <input
                  ...
                  max={11.99}
                  step={0.25}
                  value={customWidthParts.inches}
                  onChange={e => setCustomWidth(Math.max(0.5, composeDimensionInches(customWidthParts.feet, e.target.value)))}
                  className="h-9 rounded border border-zinc-300 px-2 text-sm"
                />
              ...
              <div className="grid grid-cols-[1fr_1fr_auto] gap-1">
                <input
                  ...
                  min={0}
                  step={1}
                  value={customHeightParts.feet}
                  onChange={e => setCustomHeight(Math.max(0.5, composeDimensionInches(e.target.value, customHeightParts.inches)))}
                  className="h-9 rounded border border-zinc-300 px-2 text-sm"
                />
                <input
                  type="number"
                  ...
                  max={11.99}
                  step={0.25}
                  value={customHeightParts.inches}
                  onChange={e => setCustomHeight(Math.max(0.5, composeDimensionInches(customHeightParts.feet, e.target.value)))}
                  className="h-9 rounded border border-zinc-300 px-2 text-sm"
                />
