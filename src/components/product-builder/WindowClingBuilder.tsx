...
import SizeInputPanel, { composeDimensionInches, formatSizeLabel, toFeetAndInches } from "@/components/product-builder/SizeInputPanel";
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white shadow-sm">
            ...
            <BuilderBottomToolbar
              panels={[
                ...
                { id: "contour", title: "Contour Cut", value: contourCut ? "Enabled" : "Disabled", width: 280, content: <button type="button" onClick={handleContourToggle} className={`h-9 w-full rounded border px-3 text-xs font-semibold transition ${contourCut ? "border-[var(--brand-primary)] bg-[var(--brand-primary-soft)] text-[var(--brand-primary)]" : "border-zinc-300 bg-white text-zinc-700 hover:border-zinc-400"}`}>{contourCut ? "Enabled" : "Disabled"}</button> },
