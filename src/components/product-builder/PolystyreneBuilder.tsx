    ...
    <div className="flex h-[calc(100vh-88px)] overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-3 md:p-4">
        ...
        <div className="mb-3 rounded-2xl border border-zinc-200 bg-white p-3 shadow-sm">
          <div>
            ...
            <h1 className="mt-1 text-3xl font-semibold tracking-tight text-zinc-900">Polystyrene Configurator</h1>
            <p className="mt-1 text-sm text-zinc-600">Signs365-style sheet layout · .03&quot; thickness · per-block artwork upload.</p>
          </div>
          <div className="rounded-xl border border-zinc-800 bg-zinc-900 px-4 py-2 text-right shadow-[0_8px_20px_rgba(0,0,0,0.18)]">
            ...
            <div className="text-xs text-zinc-300">
              {quantity} sign{quantity !== 1 ? "s" : ""} · {pricing.sheetsRequired} sheet{pricing.sheetsRequired !== 1 ? "s" : ""}
            </div>
          </div>
        </div>
          ...
          <section className="rounded-2xl border border-zinc-200 bg-white shadow-sm">
            ...
            <div className="grid gap-2 border-t border-zinc-200 bg-zinc-50 p-3 md:grid-cols-4 xl:grid-cols-8">
              ...
              <ControlBox title="Print Sides">
                <select
                  value={printMode}
                  onChange={(e) => setPrintMode(e.target.value as PolystyrenePrintMode)}
                  className="h-9 w-full rounded border border-zinc-300 bg-white px-2 text-sm"
                >
      ...
      <div className="flex w-[400px] flex-shrink-0 flex-col border-l border-zinc-200 bg-white">
        <div className="border-b border-zinc-100 px-5 py-4">
          ...
          <div className="mt-1 text-lg font-bold tracking-tight text-zinc-900">Polystyrene</div>
        </div>
                ...
                <div>
                  ...
                  {grommetsEnabled && (
                    <input
                      ...
                      min={1}
                      value={grommetCount}
                      onChange={(e) => setGrommetCount(Math.max(1, Number(e.target.value) || 1))}
