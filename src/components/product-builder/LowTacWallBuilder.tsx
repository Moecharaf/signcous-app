    ...
    <div className="flex h-[calc(100vh-88px)] overflow-hidden">
      ...
      <div className="flex w-[400px] flex-shrink-0 flex-col border-l border-zinc-200 bg-white">
        <div className="border-b border-zinc-100 px-5 py-4">
          ...
          <div className="mt-1 text-lg font-bold tracking-tight text-zinc-900">Low Tac Wall</div>
        </div>
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
          <aside className="space-y-4">
            <PanelCard eyebrow="Pricing" title="Wall Decals Breakdown">
              <div className="space-y-1">
                ...
                <BreakdownRow
                  label="Base rate"
                  value={`${formatCurrency(LOW_TAC_WALL_RATE)} / sq ft`}
                  muted={!pricing}
                />
                <BreakdownRow
                  label="Base price"
                ...
                <BreakdownRow
                  label="Minimum floor"
                  value={formatCurrency(LOW_TAC_WALL_MIN)}
                  muted={!pricing}
                />
