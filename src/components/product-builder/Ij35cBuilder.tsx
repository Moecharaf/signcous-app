...
export default function Ij35cBuilder({ productId = 135 }: Ij35cBuilderProps) {
  ...
  const [unit, setUnit] = useState<IJ35CUnit>("inches");
    ...
    <div className="flex h-[calc(100vh-88px)] overflow-hidden">
          ...
          <div className="grid items-end gap-4 lg:grid-cols-[1fr_auto]">
            <div>
              <nav aria-label="Breadcrumb" className="flex flex-wrap items-center gap-2 text-xs text-zinc-500">
                ...
                <span>/</span>
                <span className="font-semibold text-zinc-900">3M IJ-35C</span>
              </nav>
              ...
              <h1 className="mt-3 text-3xl font-semibold tracking-tight text-zinc-900">3M IJ-35C Builder</h1>
              <p className="mt-1 text-sm text-zinc-600">
                Adhesive vinyl with automatic panel splitting and live pricing built for large-format wall, window, and display graphics.
              </p>
            </div>
      ...
      <div className="flex w-[400px] flex-shrink-0 flex-col border-l border-zinc-200 bg-white">
        <div className="border-b border-zinc-100 px-5 py-4">
          ...
          <div className="mt-1 text-lg font-bold tracking-tight text-zinc-900">Ij35c</div>
        </div>
