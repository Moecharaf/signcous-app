          ...
          <div className="rounded-2xl border border-zinc-200 bg-white shadow-sm">
            ...
            >
              <div className="grid gap-3 md:grid-cols-[0.85fr_1.4fr_0.85fr] md:items-start md:gap-8">
                <div>
                  <div className="text-[27px] leading-[0.98] font-medium uppercase tracking-tight text-zinc-900 md:whitespace-nowrap md:text-[36px]">GF 203OAPAE</div>
                ...
                <div className="text-center md:pt-1">
                  <div className="mx-auto w-full max-w-[320px]">
                    <table className="w-full border-collapse text-[10px] leading-5 text-zinc-600 md:text-[11px]">
                      ...
                      <tbody>
                        <tr>
                          <td className="py-0.5 text-left text-zinc-500">GF 203OAPAE</td>
                          <td className="py-0.5 text-left font-medium text-zinc-700">{formatCurrency(GF2030_BASE_RATE * GF2030_MARKUP)} per sq ft</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  ...
                  <>
                    ...
                    >
                      ...
                      <div className="absolute inset-0 overflow-hidden">
                        ...
                        {uploadedImage ? (
                          <Image src={uploadedImage} alt="Uploaded GF 2030APAE artwork preview" fill unoptimized className={imageDisplayMode === "stretch" ? "object-fill" : "object-contain"} />
