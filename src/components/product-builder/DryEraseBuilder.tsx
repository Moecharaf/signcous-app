    ...
    <div className="flex h-[calc(100vh-88px)] overflow-hidden">
          ...
          <div className="grid items-end gap-4 lg:grid-cols-[1fr_auto]">
            <div>
              <nav aria-label="Breadcrumb" className="flex flex-wrap items-center gap-2 text-xs text-zinc-500">
                ...
                <span>/</span>
                <span className="font-semibold text-zinc-900">Dry Erase Wall Graphics</span>
              </nav>
      ...
      <div className="flex w-[400px] flex-shrink-0 flex-col border-l border-zinc-200 bg-white">
        <div className="border-b border-zinc-100 px-5 py-4">
          ...
          <div className="mt-1 text-lg font-bold tracking-tight text-zinc-900">Dry Erase</div>
        </div>
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
          <aside className="space-y-4">
            <PanelCard eyebrow="Pricing" title="Dry Erase Breakdown">
              <div className="space-y-1">
                ...
                <BreakdownRow
                  label="Base rate"
                  value={`${formatCurrency(DRY_ERASE_RATE)} / sq ft`}
                  muted={!pricing}
                />
                <BreakdownRow
                  label="Base price"
                ...
                <BreakdownRow
                  label="Minimum floor"
                  value={formatCurrency(DRY_ERASE_MIN)}
                  muted={!pricing}
                />
