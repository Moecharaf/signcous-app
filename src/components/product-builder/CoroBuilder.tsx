        ...
        <div className="grid gap-3">
          <section className="rounded-2xl border border-zinc-200 bg-white shadow-sm">
            ...
            <div className="relative">
              {/* Canvas Area */}
              <div className="relative h-[calc(100vh-360px)] min-h-[460px] overflow-hidden rounded-b-2xl bg-[#fafaf9]"
                style={{
                  backgroundImage:
              ...
              <div className="pointer-events-none absolute left-[calc(50%-124px)] top-1/2 -translate-y-1/2 -rotate-90 text-[10px] font-semibold uppercase tracking-[0.2em] text-zinc-500">
                Left
              </div>
